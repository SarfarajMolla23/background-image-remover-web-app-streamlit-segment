...
from streamlit_image_coordinates import \
    streamlit_image_coordinates as im_coordinates
import cv2
import numpy as np
...
if file is not None:
    ...
    if col2.button('Remove background', type='primary',
        ...
        if os.path.exists(filename):
            ...
            image_bytes_encoded_base64 = base64.b64encode(image_bytes).decode(
                'utf-8')
            ...
            result_image = cv2.imdecode(
                np.frombuffer(result_image_bytes, dtype=np.uint8),
